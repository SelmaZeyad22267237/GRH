...
testpage({super.key,required this.index});
int index
;  @override
...
class _testpageState extends State<testpage> {
  ...
  Widget build(BuildContext context) {
    ...
    floatingActionButton:widget.index==1? FloatingActionButton(onPressed:(){appbarDialoge(context);},
       ...
       drawer:  Maindrawer(),
        body:CustomScrollView(slivers: [SliverAppBar(backgroundColor: Colors.transparent,flexibleSpace: MyClippingPath(),expandedHeight: 150,),SliverToBoxAdapter(child: Screens[widget.index]) ],
        ),
