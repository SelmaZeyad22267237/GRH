...
import 'package:flutter_application_3/presentationUI/ui%20pages/Edit.dart';
...
import 'package:flutter_application_3/presentationUI/ui%20pages/text.dart';
...
class _EmployerpageState extends State<Employerpage> {
  ...
  List<Employee> employes = [];
   List<Employee> employesisnosherch = [];

  _loadData() async {
    EmploiyerController.fetchEmploiyer().then((employeds) {
      
     //  print(employeds[4].photo);
      setState(() {
employesisnosherch=employeds;
        employes = employeds;
        isLoading = false;
      });
    });
    ...
    return  
        ...
        onRefresh: () => _loadData(),
          ...
          child: Column(
                  ...
                  setState(() {
                 employes=   employes
                  .where((employe) => employe.numTel!
                      .startsWith(value))
                  .toList();
                  });
                  else{
                    setState(() {
                   employes=employesisnosherch;
                    });
                  }
                  },
                              ...
                              expandedAlignment: Alignment.topLeft,        expandedCrossAxisAlignment: CrossAxisAlignment.start,
                                       ...
                                       (employes[index].photo==null)?
                                        CircleAvatar(
                                         ...
                                         backgroundImage:NetworkImage('http://192.168.125.112:8000'+employes[index].photo),
                              ), 
